...
export default function HeaderNav() {
  ...
  return (
    <div className={cx("header-nav")}>
      {!pathName.pathname.includes("explore") && <Search></Search>}
            ...
            className={cx(
              ...
              (
                e.path == "/"
                  ...
                  : pathName.pathname.includes(e.path)
              )
                ? "active"
                : ""
            )}
        ...
        <Tippy
          content={
            <div className={cx("wrap")}>
              {isToken ? (
                <>
                  <Link className={cx("content")} to="/profile">
                    Profile
                    <FontAwesomeIcon className={cx("icon")} icon={faUser} />
                  </Link>

                  <Link className={cx("content")} to="/personal/favorites">
                    Favorite
                    <FontAwesomeIcon className={cx("icon")} icon={faBookmark} />
                  </Link>

                  <Link className={cx("content")} to="/personal/historys">
                    History
                    <FontAwesomeIcon
                      className={cx("icon")}
                      icon={faClockRotateLeft}
                ...
                <>
                  <Link to="/login" className={cx("content")}>
                    Sign in
                    <FontAwesomeIcon
                      className={cx("icon")}
                      icon={faArrowRightToBracket}
                  ...
                  <Link to="/register" className={cx("content")}>
                    Sign up
          ...
          <div className={cx("menu-group")}>
            ...
            {headerNav.menu.map((el, i) => (
              <div
                ...
                className={cx(
                  "menu-item",
                  el.path == pathName.pathname ? "item-active" : ""
                )}
              >
              ...
              if (!!isToken == element.isLogin) {
                return (
                  <div
                    ...
                    className={cx(
                      "menu-item",
                      element.path == pathName.pathname ? "item-active" : ""
                    )}
                  >
                    <FontAwesomeIcon
                      className={cx("icon")}
              ...
              if (!!isToken == element.isLogin) {
                return (
                  ...
                  >
                    ...
                    <Link
                      to={element.path}
                      onClick={element.title == "Sign out" && handleSignOut}
                    >
                      {element.title}
                    </Link>
                  </div>
